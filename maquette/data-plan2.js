// Plan de comptes — classes 6, 7 et 8 (nomenclature antérieure au règlement ANC 2022-06).
window.PCG = window.PCG || {};
PCG.accounts = (PCG.accounts || []).concat([
  // ---------- Classe 6 ----------
  ["60", "Achats (sauf 603)"],
  ...
  ["608", "Frais accessoires incorporés aux achats (compte réservé, le cas échéant)"],
  ...
  ["6711", "Pénalités sur marchés (et dédits payés sur achats et sur ventes)"],
  ...
  ["672", "Charges sur exercices antérieurs (compte à la disposition des entités, en cours d'exercice)"],
  ...
  ["772", "Produits sur exercices antérieurs (compte à la disposition des entités, en cours d'exercice)"],
  ...
  ["8014", "Effets escomptés non échus"],
